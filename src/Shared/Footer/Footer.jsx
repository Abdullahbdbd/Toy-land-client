...
const Footer = () => {
    return (
        <div>
            ...
            <footer className="footer px-10 py-4 border-t bg-blue-500 text-base-content border-base-300">
                <div className="items-center grid-flow-col">
                    <img className='h-20' src="https://rosen-pbl-static-content.s3.amazonaws.com/files/boxes/luOwl-logo.png" alt="" />
